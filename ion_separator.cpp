...
const int a_precip[] = {0b111111111, 0b000000111, 0b000000111, 0b000000111, 0b000111111, 0b000111111, 0b000111111, 0b000111111}; // if precipitate is formed when adding anion solution in excess to various cation solutions
